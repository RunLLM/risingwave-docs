...
/>
  ...
  scripts: [
    ...
    {
      src: "https://cdn.jsdelivr.net/npm/@runllm/search-widget@0.0.1-alpha47/dist/run-llm-search-widget.es.js",
  ...
  stylesheets: ["https://cdn.jsdelivr.net/npm/@runllm/search-widget@0.0.1-alpha47/dist/main.css"],
  webpack: {
    jsLoader: (isServer) => ({
